...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            Intent conceptIntent2=new Intent(MainActivity.this,ConceptActivity2.class);
            startActivity(conceptIntent2);
        }else if (id == R.id.nav_quizthree) {
            Intent conceptIntent3=new Intent(MainActivity.this,ConceptActivity3.class);
            startActivity(conceptIntent3);
        }else if (id == R.id.nav_quizfour) {
            Intent conceptIntent4=new Intent(MainActivity.this,ConceptActivity4.class);
            startActivity(conceptIntent4);
        }
