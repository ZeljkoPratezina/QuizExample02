...
import com.zeljkopratezina.quizexample02.db.DBAdapter3;
import com.zeljkopratezina.quizexample02.model.Question;

import java.util.ArrayList;
import java.util.List;

public class ConceptActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final DBAdapter3 dbAdapter=new DBAdapter3(this);
            ...
            public void onClick(View v) {
                ...
                if(answer!=null){
                    ...
                    if(questionId<dbAdapter.rowCount()){
                        ...
                        Intent intent = new Intent(ConceptActivity3.this, ResultActivity.class);
