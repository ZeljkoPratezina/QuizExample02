...
import com.zeljkopratezina.quizexample02.db.DBAdapter4;
import com.zeljkopratezina.quizexample02.model.Question;

import java.util.ArrayList;
import java.util.List;

public class ConceptActivity4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final DBAdapter4 dbAdapter=new DBAdapter4(this);
            ...
            public void onClick(View v) {
                ...
                if(answer!=null){
                    ...
                    if(questionId<dbAdapter.rowCount()){
                        ...
                        Intent intent = new Intent(ConceptActivity4.this, ResultActivity.class);
